...
blockstart = 170399
blockstart += 59711
#blockcount = urllib2.urlopen("https://blockchain.info/rawblock/$block_hash").read()
blockcount = urllib2.urlopen("https://blockchain.info/q/getblockcount").read()

print (Fore.YELLOW +"WELCOME TO R-scan v0.1.2!")

print "ADDRESS-R-SCAN: "
addr = raw_input("type address:  ")
urladdr = "https://blockchain.info/rawaddr/" + str(addr)
#control api-url
print urladdr 
